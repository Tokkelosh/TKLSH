...
// Tokkelosh: total coins staked (non-spendable until maturity)
...
// Tokkelosh: check 'spent' consistency between wallet and txindex
// Tokkelosh: fix wallet spent state according to txindex
...
// Tokkelosh: disable transaction (only for coinstake)
