...
static const uint256 hashGenesisBlock("0x0ac02b6b31f3c4804b62154b8eea02b4eefbb088cf1d9eb9f570b1847952354c");
...
public:
    ...
    {
        // Tokkelosh: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Tokkelosh: get transaction coin age
...
public:
    ...
    // Tokkelosh: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Tokkelosh: two types of block: proof-of-work or proof-of-stake
    ...
    // Tokkelosh: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Tokkelosh: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Tokkelosh: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Tokkelosh: block index flags
    enum
    {
